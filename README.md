...
Для успешного прохождения занятия необходимо сделать в срок [Домашнее Задание](/homework/HOMEWORK.md).
Для установки проекта воспользуйтесь [инструкцией](/readme/GUIDE_Project_Installation.md). 
Для запуска проекта воспользуйтесь [инструкцией](/readme/GUIDE_Project_Running.md).  
